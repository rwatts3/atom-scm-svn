...
module.exports = (TortoiseSvn = {
  ...
  activate(state) {
	atom.commands.add("atom-workspace", {"tortoise-svn:blameFromTreeView": () => this.blameFromTreeView()});
	atom.commands.add("atom-workspace", {"tortoise-svn:blameFromEditor": () => this.blameFromEditor()});

	atom.commands.add("atom-workspace", {"tortoise-svn:commitFromTreeView": () => this.commitFromTreeView()});
	atom.commands.add("atom-workspace", {"tortoise-svn:commitFromEditor": () => this.commitFromEditor()});

	atom.commands.add("atom-workspace", {"tortoise-svn:diffFromTreeView": () => this.diffFromTreeView()});
	atom.commands.add("atom-workspace", {"tortoise-svn:diffFromEditor": () => this.diffFromEditor()});

	atom.commands.add("atom-workspace", {"tortoise-svn:logFromTreeView": () => this.logFromTreeView()});
	atom.commands.add("atom-workspace", {"tortoise-svn:logFromEditor": () => this.logFromEditor()});

	atom.commands.add("atom-workspace", {"tortoise-svn:revertFromTreeView": () => this.revertFromTreeView()});
	atom.commands.add("atom-workspace", {"tortoise-svn:revertFromEditor": () => this.revertFromEditor()});

	atom.commands.add("atom-workspace", {"tortoise-svn:updateFromTreeView": () => this.updateFromTreeView()});
	atom.commands.add("atom-workspace", {"tortoise-svn:updateFromEditor": () => this.updateFromEditor()});

	atom.commands.add("atom-workspace", {"tortoise-svn:switchFromTreeView": () => this.switchFromTreeView()});

	atom.commands.add("atom-workspace", {"tortoise-svn:addFromTreeView": () => this.addFromTreeView()});
	atom.commands.add("atom-workspace", {"tortoise-svn:addFromEditor": () => this.addFromEditor()});

	atom.commands.add("atom-workspace", {"tortoise-svn:renameFromTreeView": () => this.renameFromTreeView()});
	atom.commands.add("atom-workspace", {"tortoise-svn:renameFromEditor": () => this.renameFromEditor()});

	atom.commands.add("atom-workspace", {"tortoise-svn:lockFromTreeView": () => this.lockFromTreeView()});
	atom.commands.add("atom-workspace", {"tortoise-svn:lockFromEditor": () => this.lockFromEditor()});

	atom.commands.add("atom-workspace", {"tortoise-svn:unlockFromTreeView": () => this.unlockFromTreeView()});
	atom.commands.add("atom-workspace", {"tortoise-svn:unlockFromEditor": () => this.unlockFromEditor()});

	return atom.commands.add("atom-workspace", {"tortoise-svn:checkoutSVN": () => this.checkoutSVN()});
  },
  blameFromTreeView() {
	const currFile = resolveTreeSelection();
	if (currFile != null) { return blame(currFile); }
  },
  ...
  commitFromTreeView() {
	const currFile = resolveTreeSelection();
	if (currFile != null) { return commit(currFile); }
  },
  ...
  diffFromTreeView() {
	const currFile = resolveTreeSelection();
	if (currFile != null) { return diff(currFile); }
  },
  ...
  logFromTreeView() {
	const currFile = resolveTreeSelection();
	if (currFile != null) { return log(currFile); }
  },
  ...
  revertFromTreeView() {
	const currFile = resolveTreeSelection();
	if (currFile != null) { return revert(currFile); }
  },
  ...
  updateFromTreeView() {
	const currFile = resolveTreeSelection();
	if (currFile != null) { return update(currFile); }
  },
  ...
  switchFromTreeView() {
	const currFile = resolveTreeSelection();
	if (currFile != null) { return tsvnswitch(currFile); }
  },

  addFromTreeView() {
	const currFile = resolveTreeSelection();
	if (currFile != null) { return add(currFile); }
  },
  ...
  renameFromTreeView() {
	const currFile = resolveTreeSelection();
	if (currFile != null) { return rename(currFile); }
  },
  ...
  lockFromTreeView() {
	const currFile = resolveTreeSelection();
	if (currFile != null) { return lock(currFile); }
  },
  ...
  unlockFromTreeView() {
	const currFile = resolveTreeSelection();
	if (currFile != null) { return unlock(currFile); }
  },
